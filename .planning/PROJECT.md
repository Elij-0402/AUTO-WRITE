...
- [ ] 用户可以创建/管理小说项目（一本小说一个项目）
- [ ] 章节管理——创建、编辑、排序章节，平面结构（无卷层）
- [ ] 世界观百科——定义角色（姓名、外貌、性格、背景、关系）、地点、规则/设定、时间线
- [ ] 世界观条目关联——手动建立条目间关系 + AI 建议关联
- [ ] 大纲/情节规划——可视化情节结构、章节大纲
- [ ] 从大纲生成整章——类似 Sudowrite Story Engine，基于大纲 + 世界观自动生成完整章节
- [ ] AI 聊天交互——对话式讨论后生成草稿，草稿在聊天面板展示，手动采纳到编辑器
- [ ] AI 自动注入上下文——生成前自动读取相关世界观条目、角色、情节
- [ ] AI 主动矛盾检查——检测与已建立设定矛盾的内容
- [ ] 选中文字与 AI 讨论——在编辑器中选中文字，在 AI 聊天中针对该片段讨论
- [ ] 多面板工作区——世界观百科、大纲、编辑器、AI 聊天同时可见
